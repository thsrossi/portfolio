...
export default function MainSection(){
  ...
  const [fullDesciption, setFullDesciption] = useState(
    "Sou desenvolvedor Front-end e mobile focado em React, performance e aplicações responsivas. Atualmente, trabalho como Desenvolvedor Front-end e mobile na MaxCore Informática, onde utilizo ReactJS e React Native com TypeScript e tecnologias suplementares como Git, Chakra UI, Material UI, Bootstrap."
  )
